...
This project is a Mautic 6 installation managed via Composer, with the AWS SES plugin included for email delivery via Amazon Simple Email Service.
...
# Original Mautic Template Documentation
